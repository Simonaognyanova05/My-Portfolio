...
export default function AdminAbout() {
    ...
    const createHandler = async(e) => {
        ...
        const {subject, description, img, link} = Object.fromEntries(formData);

        let res = await createEducation(subject, description, img, link);

        if(res.status == 200){
            alert("Education was added successfuly!");
            navigate('/');
        }else{
            alert("Error!");
        }
        ...
        <section className="section contact-me" data-section="section4">
            <div className="container">
                <div className="section-heading">
                    ...
                    <span>You can add a new education here</span>
                </div>
                <div className="row">
